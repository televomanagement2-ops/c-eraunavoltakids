...
export default function Login () {
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setNotice('Accesso riuscito. Puoi continuare sulla vetrina o in admin se il tuo profilo è staff.')
  }
    ...
    <PageShell>
      <section className="section login-page">
        <div className="section__header">
          ...
          <p>
            {configured
              ? 'Usa Supabase Auth (email o Google quando abilitato in dashboard).'
              : 'Aggiungi VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY nel file .env per collegarti al backend.'}
          </p>
        </div>
        ...
        <div className="login-card">
          ...
          <form className="login-form" onSubmit={onSubmit}>
            <label className="contact-field">
              <span>Email</span>
              <input type="email" name="email" autoComplete="email" placeholder="nome@posta.it" />
            </label>
            <label className="contact-field">
              <span>Password</span>
